...
/* package TicTacToe-0.1.0.0 */
#define VERSION_TicTacToe "0.1.0.0"
#define MIN_VERSION_TicTacToe(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
/* package http-client-0.5.4 */
#define VERSION_http_client "0.5.4"
...
#define CURRENT_COMPONENT_ID "TicTacToe-0.1.0.0-2GFTCrDE88EHXWV61MAl5D"

#define CURRENT_PACKAGE_KEY "TicTacToe-0.1.0.0-2GFTCrDE88EHXWV61MAl5D"
